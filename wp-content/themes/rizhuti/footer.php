            ...
            <div class="row">
                <div class="col l6 m6 s12">
                    ...
                    &copy; <?php echo date('Y'); ?> <a href="<?php bloginfo('url'); ?>"><?php bloginfo('name'); ?></a> &nbsp; 
                        ...
                        &nbsp;<?php echo _hui('web-icp-info') ? _hui('web-icp-info').' &nbsp; ' : ''; ?>
					</div>
                </div>
                <div class="col l6 m6 s12">
                    <ul class="copyright-links">
						...
						<li><a target="_blank" href="https://bbs.5g-yun.com/">5G云源码网</a></li>
                     </ul>
                </div>
            </div>
        </div>
